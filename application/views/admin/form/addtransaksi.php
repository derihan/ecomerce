	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Add Transaksi</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="panel panel-container">
			<div class="row">
				...
				<div class="panel-body">
				  <form class="form" action="<?php echo base_url('home/procbayaradm') ?>" method="post" id="registrationForm" enctype="multipart/form-data" >
                      
					<div class="form-group">		
						<label ><h4> NO Tagihan anda :</h4></label>
                         <input type="text" name="ivc" value="" class="form-control" style="visibility:;" required="" />
               		</div>
					<div class="form-grup"> 
                    	<label for="first_name"><h4> Total bayar anda</h4></label>
                    	<input type="text" name="tobar" value="" class="form-control" required="" />
                 	</div>
                 	<div class="form-group">
                	...
                	<div class="form-group">
                     ...
                     <a href="<?php echo base_url('home/showtransaksi') ?>"><button class="btn btn-primary">Kembali</button></a>
                 	</div>			
				    </form>
				</div>
			</div>
