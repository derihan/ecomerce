						...
						<div class="panel-body">
							<form class="form-horizontal row-border" action="<?php echo base_url('home/editproses') ?>" enctype="multipart/form-data" method="POST">
								<div class="form-group">
									...
									<input type="text" name="idk" hidden="" value="<?php echo $where->id_brand ?>">
									<label class="col-md-2 control-label">Manufacture</label>
									<div class="col-md-10">
										<input type="text" name="mnfc" class="form-control" required="" value="<?php echo $where->manufacture ?>" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Nama Brand</label>
									<div class="col-md-10">
										<input type="text" name="nama" class="form-control" required="" value="<?php echo $where->nama_brand ?>" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Alamat</label>
									<div class="col-md-10">
										<input type="text" name="alamat" class="form-control" required="" value="<?php echo $where->alamat ?>" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">email</label>
									<div class="col-md-10">
										<input type="text" name="email" class="form-control" required="" value="<?php echo $where->email ?>" >
									</div>
								</div>
								<div class="form-group">
