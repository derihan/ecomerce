				...
				<div class="col-lg-12">
					<div class="panel ">
						...
						<div class="panel-body">
							<div>
								<a href="<?php echo base_url('home/addtransaksi') ?>"><button class="btn btn-primary">Tambah</button></a>
							</div>
							<?php
							foreach ($value as $idns) {
							?>
							<div class="col-lg-12">
								<br>
									...
									<a href="<?php echo base_url('home/deltrans')?>/<?php echo $idns->id_transaksi ?>"><button class="btn btn-danger">Hapus data</button></a>
									<a href="<?php echo base_url('home/edittrans')."/".$idns->id_transaksi ?>"><button class="btn btn-warning">Edit data</button></a>
									<br>
								<hr>
							</div>
							<hr>
